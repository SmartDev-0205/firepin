        ...
        <div id="body">
                ...
                <div className="container"
                    ...
                    <Grid container>
                        ...
                        <Grid item
                            ...
                            <p>Token Contract Address: 0x2F1F71377e5C1070c6694171CFBde0eb6daf8023</p>
                        </Grid>
                    </Grid>
                    ...
                    <Grid container id="scroll"
                        ...
                        <Grid item
                            ...
                            <a data-jarallax-element="-40" href="" className="economy__video-btn video-btn popup-youtube"
                                style={
                                    {transform: "translate3d(0px, -9.08485px, 0px)"}
                                }
                                data-jarallax-original-styles="transform: translate3d(0px, 114.859px, 0px);">
                                <img src={video_btn_img}
                            ...
                            <div className="economy__block">
                                <div className="economy__block-content">
                                    <div className="section-header section-header--white section-header--tire section-header--small-margin">
                                        ...
                                        <h2>
                                            We Are All In One &nbsp;
                                            <span>DAO &amp; METAVERSE Company</span>
                                        </h2>
                                    </div>
                                    <p>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            is to use treasury funds allocated from users towards NFT Game development, 3D &amp; METAVERSE VR Games, along with investing directly into teams and corporations that have a long term vision on METAVERSE games and P2E!
                                        </li>
                                        <li>
                                ...
                                <div data-aos-once="true" data-aos="fade-right">
                                    <div className="aos-item__inner">
                                        ...
                                        <div className="about__animated-content">
                                            <p>
                                                Community Led DAO platform with METAVERSE integration.
                                            </p>
                                            <ul>
                                                <li>Staking Platform and Farming</li>
                                                <li>A percentage of each transaction is allocated towards treasury.</li>
                                                <li>Multi Chain integration for better user experience.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="road"
                            ...
                            <div className="road__item">
                                ...
                                <div className="road__item-content">
                                    ...
                                    <p></p>
                                    <p>METAVERSE Game Development Phase 2 - Test</p>
                                    <p></p>
                                </div>
                            </div>
                            <div className="road__item road__item">
                                ...
                                <div className="road__item-content">
                                    ...
                                    <p></p>
                                    <p>
                                        <b>Big Data application integration and DAO Integration</b>
                                    </p>
                                    <p></p>
                                </div>
                            </div>
                        ...
                        <section className="partner">
                            <div className="partners-logo__block">
                                <div className="partners-logo__item">
                                    <img src={partner_icon1}
                                        alt=""/>
                                    <p>BSCSCAN</p>
                                </div>
                                <div className="partners-logo__item">
                                    <img src={partner_icon2}
                                        alt=""/>
                                    <p>COINMARKETCAP</p>
                                </div>
                                <div className="partners-logo__item">
                                    <img src={partner_icon3}
                                        alt=""/>
                                    <p>COINGECKO</p>
                                </div>
                                <div className="partners-logo__item">
                                    <img src={partner_icon4}
                                        alt=""/>
                                    <p>CERTIK</p>
                                </div>
                            </div>
            ...
            <section className="case">
                                ...
                                <div className="aos-item__inner">
                                    <div className="flex">
                                        ...
                                        <div className="cases__item-content">
                                            ...
                                            <p className="cases__item-text">
                                                Liquidity Pool fees and Bond sales increase the treasury revenue, and lock in liquidity and helping to control supply.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div style={
                    ...
                    <a href="https://pancakeswap.finance/swap?outputCurrency=0x2F1F71377e5C1070c6694171CFBde0eb6daf8023" className="btn btn--orange btn--uppercase"
                        style={
                            {padding: "5px 10px"}
                    }>
                        <span>Buy $PXDS on PancakeSwap</span>
                ...
                <Grid container justifyContent="center"
                    ...
                    <div className="container"
                        ...
                        <Grid item
                            ...
                            md={3}>
                            <div className="counter__item">
                                <div className="counter__item-title">PRE-SALE TOKEN Allocation</div>
                                <div className="counter counter__item-value counter__item-value--blue numscroller">0.000067</div>
                            </div>
                        </Grid>
                        <Grid item
                            ...
                            md={3}>
                            <div className="counter__item">
                                <div className="counter__item-title">Total PRE-SALE TOKEN</div>
                                <div className="counter counter__item-value counter__item-value--blue numscroller">0.000067</div>
                            </div>
                        </Grid>
                        <Grid item
                            ...
                            <div className="counter__item">
                                <div className="counter__item-title">Total PRE-SALE TOKEN</div>
                                <div className="counter counter__item-value counter__item-value--blue numscroller">1</div>
                            </div>
                        </Grid>
                    </div>
                </Grid>
                                    ...
                                    <div className="aos-item__inner">
                                        <div className="col-lg-6 offset-lg-6 token__animated-content aos-init aos-animate">
                                            ...
                                            <ul className="token__info-list">
                                                ...
                                                <li>
                                                    <span>PHASE 2 PRE-SALE:</span>
                                                    15/04/2022 - 12/05/2022
                                                </li>
                                                <li>
                                                    <span>PHASE 3 PRE-SALE:</span>
            ...
            <section className="docs" id="paper"
                style={
                    {marginTop: "-500px"}
            }>
                <div className="container">
                                ...
                                <section>
                                    ...
                                    <div className="stats">
                                        <ul>
                                            <li data-name="dis">
                                                50% Distribution</li>
                                            <li data-name="presale">30% Pre-Sale</li>
                                            <li data-name="Team">
                                                10% Team Funds</li>
                                            <li data-name="Marketing">10% Marketing</li>
                                    ...
                                    <div className="aos-item__inner">
                                        <div className="col-lg-6 offset-lg-6 token__animated-content aos-init aos-animate">
                                            <div className="section-header section-header--tire section-header--small-margin">
                                                ...
                                                <h2>Token Distribution & Deployment
                                                </h2>
                                                <div className="bg-title">
                                            ...
                                            <ul className="token__info-list">
                                                ...
                                                <li>
                                                    <span>Third Chain and later on:</span>
                                                    To be decided with user votes.
                                                </li>
