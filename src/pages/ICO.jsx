    ...
    return (
        <>
            ...
            <section className="inner-banner top-back-img">
                {!active ? (
                    <button className="top_connect_btn" onClick={toggleOpen} style={{marginTop: "100px"}}>
                        Connect Wallet{" "}
                    </button>
                ) : (
                    <button className="top_connect_btn" onClick={disconnect} style={{marginTop: "100px"}}>Disconnect</button>
                )}
                        ...
                        <div className="col-lg-12 col-xl-12 text-center">
                            <Grid container spacing={2} justifyContent="center">
                                <Grid item xs={10} md={10}>
                                    <h5 className="title-content">FIREPIN SWAP</h5>
                                </Grid>

                                <Grid item xs={10} md={10}>
                                    <h5 className="title-description">Receive your Firepin tokens instantly in 3 simple steps! Select your desired method of payment, add your receiving wallet address & pay. Simple!</h5>
                                </Grid>
                            ...
                            <div className="game-details-left">
                                <div id="coin-flip-cont">
                                    <div className="coins-wrapper">
                                        <div className="front">
                                            <img src={bnbpng} style={{ zIndex: -1000 }} alt="game" />
                                        </div>
                                        <div className="back">
                                            <img src={shibapng} style={{ zIndex: -1000 }} alt="game" />
                                        </div>
                                    </div>
                                </div>
